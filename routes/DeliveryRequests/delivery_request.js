module.exports = function(server) {
  ...
  server.post('/api/delivery_requests/', isLoggedin, async function(req, res, next) {
  ...
  server.get('/api/delivery_requests/:delivery_request_id', isLoggedin, async function(req, res, next) {
  ...
  server.get('/api/delivery_requests/', isLoggedin, async function(req, res, next) {
    DeliveryRequest.find({}, function (err, delivery_request_list) {
      return res.status(200).json(delivery_request_list)
    });
  })

  server.patch('/api/delivery_requests/:delivery_request_id', isLoggedin, async function(req, res, next) {
    const reqDeliveryRequestId = req.params.delivery_request_id
